...
$.fn.signaturePad.defaults = {
  ...
  , errorMessage : 'กรุณากรอกชื่อผู้รับ' // The error message displayed on invalid submission
  , errorMessageDraw : 'กรุณาเซ็นชื่อผู้รับ' // The error message displayed when drawOnly and no signature is drawn
